...
- Screen captures and GIFs/Videos help a lot.
...
- We use **TypeScript** and strictly typed code.
- Run tests before submitting: `npm test`
- Follow the existing code style (clean, readable, commented where necessary).
